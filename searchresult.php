...
<div class="wrapper row2">
  <div id="container" class="clear">
	...
	for( $j = 0; $j<$i; $j++ ) {
		...
		$sql = $sql."r_name LIKE '%$check[$j]%' OR a_name LIKE '%$check[$j]%' OR c_name LIKE '%$check[$j]%' OR  r_year = '$check[$j]' OR word LIKE '%$check[$j]%'";
	 }
    ...
    mysqli_free_result($result2);
		...
		mysqli_close($conn);
	?>
	<center> <a href='simple_search.php' class='w3-button w3-brown w3-hover-black'>Search Again</a> <center>
      </section>
    </div>
  </div>
</div>
